...
#define kSureBtnColor [UIColor colorWithRed:0/255.f green:124/255.f blue:198/255.f alpha:1.0]
...
+ (FYLCityPickView *)showPickViewWithComplete:(FYLCityBlock)block{
    return [self showPickViewWithDefaultProvince:@"北京市" complete:block];
}
