...
@interface NomalRefreshVC ()<UITableViewDataSource, UITableViewDelegate>
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    RefreshCell *cell = [RefreshCell cellWithTableView:tableView];
