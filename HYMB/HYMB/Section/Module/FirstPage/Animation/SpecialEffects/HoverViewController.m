...
@interface HoverViewController () <YNPageViewControllerDataSource, YNPageViewControllerDelegate, SDCycleScrollViewDelegate>
...
+ (instancetype)suspendTopPausePageVC {
    ...
    HoverViewController *vc = [HoverViewController pageViewControllerWithControllers:[self getArrayVCs]
    ...
    __weak typeof(HoverViewController *) weakVC = vc;
