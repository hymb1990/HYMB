...
#import "JsonAnimationVC.h"
#import "JsonAnimationPlayVC.h"
@interface JsonAnimationVC ()<UITableViewDataSource, UITableViewDelegate>
...
@implementation JsonAnimationVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NSString *fileURL = self.jsonFiles[indexPath.section];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    JsonAnimationPlayVC *VC = [JsonAnimationPlayVC new];
    VC.type = components.lastObject;
