...
//
//    LOTAnimationView *animation = [LOTAnimationView animationNamed:@"M"];
...
@interface LottieVC ()<UITableViewDataSource, UITableViewDelegate>
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    MYLog(@"%@", indexPath);
    if (indexPath.section == 0) {
        JsonAnimationVC *VC = [JsonAnimationVC new];
